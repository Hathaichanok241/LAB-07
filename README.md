...
Hello!	| ใช้ไม่ได้|	มีเครื่องหมาย ! อยู่
w*h 	|ใช้ไม่ได้ |	เครื่องหมายทางคณิตศาสตร์อยู่ในชื่อ		
time	| ใช้ได้| 			
do	|ใช้ไม่ได้ |	เป็นคำสงวนในภาษา C#		
Do	|ใช้ได้| |			
21November	|ใช้ไม่ได้ |	มีตัวเลขผสมอยู่
ladkrabang	| ใช้ได้|			
Student ID	|ใช้ไม่ได้ |	มีการเว้นวรรค
...
### y = x2
<hr>
![](https://github.com/Hathaichanok241/LAB-07/blob/master/Imgs/7.6.0.JPG?raw=true)
<hr>
### y = cos(x)
<hr>
![](https://github.com/Hathaichanok241/LAB-07/blob/master/Imgs/7.6.0.JPG?raw=true)
